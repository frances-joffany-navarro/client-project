...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210822_cfsj_63df7ed0378cacfc2308_20210919151907_archive.zip';
	const ARCHIVE_SIZE		 = '61195672';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '63df7ed-19151907';
    const SECONDARY_PACKAGE_HASH = '2828a49-19151907';
	const VERSION			 = '1.4.2';
