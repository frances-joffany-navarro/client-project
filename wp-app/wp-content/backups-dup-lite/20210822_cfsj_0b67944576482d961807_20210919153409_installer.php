...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210822_cfsj_0b67944576482d961807_20210919153409_archive.zip';
	const ARCHIVE_SIZE		 = '61197073';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0b67944-19153409';
    const SECONDARY_PACKAGE_HASH = 'e3e428b-19153409';
	const VERSION			 = '1.4.2';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.4.2==');
		self::log('----------------------------------------------------');
