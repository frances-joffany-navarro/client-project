...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210822_cfsj_7caf58f69861b1602124_20210822120402_archive.zip';
	const ARCHIVE_SIZE		 = '57774839';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7caf58f-22120402';
    const SECONDARY_PACKAGE_HASH = '97b25bc-22120402';
	const VERSION			 = '1.4.2';
